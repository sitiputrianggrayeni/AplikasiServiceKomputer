    ...
    <div class="col-12">
        <div class="col-md-12">
            <div class="card border-0 shadow-sm rounded">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.Keluhan.update', $keluhan->id_keluhan)); ?>" method="POST" >
                      <?php echo csrf_field(); ?>
                      <?php echo method_field('PUT'); ?>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Keluhan</label>
                            <input type="text" name="nama_keluhan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter nama barang" value="<?php echo e(old('nama_barang', $keluhan->nama_keluhan)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="ongkos" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter merek" value="<?php echo e(old('ongkos', $keluhan->ongkos)); ?>">
                          <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\ServisKomputer\resources\views/levelAdmin/keluhan/edit.blade.php ENDPATH**/ ?>