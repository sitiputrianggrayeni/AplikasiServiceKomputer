...
<head>
  ...
  <title>Dashboard Servis Komputer</title>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <?php echo $__env->make('template.sidebarAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?> 
            <?php if(auth()->user()->level =='pegawai'): ?>
            <?php echo $__env->make('template.sidebarPegawai', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?> 
            <?php if(auth()->user()->level =='customer'): ?>
            <?php echo $__env->make('template.sidebarCustomer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?> 
          </ul>
          </li>
          </ul>
...
</html><?php /**PATH C:\Users\User\ServisKomputer\resources\views/template/app.blade.php ENDPATH**/ ?>