                        ...
                        <tbody>
                            @forelse ($customers as $index => $dataCustomer)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('admin.Customer.destroy', $dataCustomer->customer_id) }}" method="POST">
                                            <a href="{{ route('admin.Customer.show', $dataCustomer->customer_id) }}" class="btn btn-sm btn-success">SHOW</a>
                                            <a href="{{ route('admin.Customer.edit', $dataCustomer->customer_id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
