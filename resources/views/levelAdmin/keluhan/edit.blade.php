                    ...
                    <form action="{{ route('admin.Keluhan.update', $keluhan->id_keluhan) }}" method="POST" >
                      ...
                      @method('PUT')
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_keluhan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter nama barang" value="{{ old('nama_barang', $keluhan->nama_keluhan) }}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="ongkos" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter merek" value="{{ old('ongkos', $keluhan->ongkos) }}">
                          <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                          @error('ongkos')
                          <div class="alert alert-danger mt-2">
                              {{ $message }}
